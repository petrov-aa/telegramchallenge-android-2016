...
public class SurfaceView4_3 extends SurfaceView {
    ...
    public SurfaceView4_3(Context context, AttributeSet attrs, int defStyle) {
    ...
    public SurfaceView4_3(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        density = getResources().getDisplayMetrics().density;
        heightScreen = getResources().getSystem().getDisplayMetrics().heightPixels;
    ...
    public SurfaceView4_3(Context context) {
        super(context);
        this.context = context;
        density = getResources().getDisplayMetrics().density;
        heightScreen = getResources().getSystem().getDisplayMetrics().heightPixels;
